...
> A Q1 2026 roundup of outside cost indexes, now two quarters old. Turn it into one index tracker on a URL without year or quarter, and link Quotr's own price index when it launches.
...
- **Freshness:** It covers Q1 2026 only, and its sitemap date is 2026-06-03. On 2026-09-26, Q2 has closed and Q3 ends in days, so newer releases have probably replaced its numbers. *(from 2026-09-25 audit (blog sitemap); 'replaced' is inferred)*
...
- **Uniqueness:** The vault calls it a third-party data roundup (PPI, RSMeans, Mortenson) and plans to link Quotr's own index once it exists. Nothing suggests the page holds Quotr data. *(from 2026-09-25 audit; 'no Quotr data' inferred)*
- **Uniqueness:** Overlap group G07 keeps it separate from construction-cost-trends-2026, the keeper for 'why did costs go up'. This page should own the index numbers; the trends page owns the explanation. *(agreed overlap map)*
- **Visibility:** Its prompt, L-124 (Medium), was not tested, and no AI test cites it. The ENR cost page is recorded as where buyers ask the question, not as an AI citation. Web search was not checked. Scored 3: unknown, with no negative test. *(from vault prompt library (L-124); no data: not checked in search on 2026-09-26)*
...
- **Trust:** The slug names the outside sources. The byline was not seen. *(inferred from the slug; byline no data)*
...
**Related tasks:** [[A7 Named author bylines and author pages|A7]], [[A9 Sitemaps and lastmod dates|A9]], [[C1 Publish the first original dataset|C1]], [[D4 Second price-index edition, Q1 2027 (R-51)|D4]]
