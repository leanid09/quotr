...
**What this page is for:** A dated record of every meaningful change to this knowledge brain: what changed, why, which files, and who checked it. Anyone updating the brain adds an entry here, newest first, using the template at the bottom.

**Last updated:** 2026-09-25

**Sources:** the QA and integration record in [qa-log.md](qa-log.md); the research files listed in [../sources.md](../sources.md).
...
- If a **fact about Quotr** changed, say what the old and new values were and where the new value came from (Quotr sign-off, a live page, a re-test). Update [../00-quotr/entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md) first, then the other pages.
- If a **TO CONFIRM** item was answered, remove it from the list in [qa-log.md](qa-log.md) §6 and note it here.
- After any edit session, run the link check (method in [qa-log.md](qa-log.md) §5) and record the result.
...
**Checked by:** five section QA passes, then an integrator pass (see [qa-log.md](qa-log.md))
...
- Added the root files: [../README.md](../README.md) (start here), [../ai-context-pack.md](../ai-context-pack.md) (AI briefing, about 1,750 words) and [../sources.md](../sources.md) (about 950 unique outside sources, grouped by type).
- Added this `_meta` folder: [qa-log.md](qa-log.md) and this changelog.
...
**Corrections made during QA** (summary; full list in [qa-log.md](qa-log.md))
...
**Open items carried forward:** the TO CONFIRM list in [qa-log.md](qa-log.md) §6.
...
- [qa-log.md](qa-log.md) — the 2026-09-25 QA record, link-check method and the TO CONFIRM list
- [../README.md](../README.md) — the monthly maintenance routine
- [../00-quotr/entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md) — update this first when a Quotr fact changes
- [../04-prompt-library/tracking-set.md](../04-prompt-library/tracking-set.md) — the monthly test whose results you log here
