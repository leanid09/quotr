...
**Sources:** the final report <../../reports/Quotr GEO AEO strategy audit.md> (sections "Existing vs new content" and "A 90-day plan"); research notes <../../research_notes/Quotr GEO AEO strategy audit/quotr_onsite_content_audit.md> (full inventory, §1–§6), <../../research_notes/Quotr GEO AEO strategy audit/verification_quotr_and_competitors.md> (corrections: ~13 stale-price URLs, /terms HQ, PlanSwift ownership, staging host), <../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md> (freshness evidence and claim H6), <../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md> (§2), <../../research_notes/Quotr GEO AEO strategy audit/quotr_ai_visibility_tests.md> (which pages AI cites); brain pages [../02-current-state/website-audit.md](../02-current-state/website-audit.md) (list of all 96 posts), [../02-current-state/geo-tactics-already-used.md](../02-current-state/geo-tactics-already-used.md), [../00-quotr/entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md) (inconsistency register), [../04-prompt-library/prompt-library.md](../04-prompt-library/prompt-library.md) (prompt IDs).
...
**Recommended effort split** (our recommendation, explained below): October 2026 is about 75% fix/refresh; from November to March about 20–25% refresh and maintenance, about 45–50% new unique assets, about 20–25% support for off-site work.
...
|---|---|---|
| Old "Solo $299.90 / Team $499.90" pricing is still live on about **13 Quotr URLs** plus llms.txt; Perplexity answered "Quotr.ai vs Togal.AI" with "from about $299.90/month" (real entry price: $79.90) | Old pages are doing active damage; fixing them is the fastest win | Report; <../../research_notes/Quotr GEO AEO strategy audit/verification_quotr_and_competitors.md> claim 7, Gaps filled #2 |
...
| Google Overviews care much less about freshness than ChatGPT | Refresh commercial pages when facts change; do not churn evergreen pages | Ahrefs, as above |
...
| The fact-check's own wording: "Fix and consolidate what already ranks or gets cited, then put most effort into net-new content that has original data or decision support." | Our recommended sequence | <../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>, hype flag H6 |

"Refresh first" alone is a practitioner sequence, not a research finding (verification file, H6). That is why the plan below limits refreshing to pages with wrong facts, pages AI already uses, and pages that target high-priority prompts.
...
**Refresh cadence** (a working hypothesis, not a tested rule; verification file H20): pricing and comparison pages, check every quarter and whenever a price changes; data reports, on their published schedule; evergreen how-tos, only when something changes.
...
| [is-ai-takeoff-actually-accurate-yet](https://quotr.ai/blog/is-ai-takeoff-actually-accurate-yet/) | First citation for P5 (94–99% on clean vector sets, 80s on scans), unnamed | "In Quotr.ai's internal testing…"; link to the method page when it exists | P1 |
...
| 10 | **Accuracy claim** | "95–99% accuracy on clean vector PDFs (Quotr internal benchmarking)" (blog); "95% accuracy" (Product Hunt); engines call it "self-published" | Keep "Quotr internal benchmarking" with conditions until a method page is published | Blog posts, Product Hunt |
...
Inventory source: [../02-current-state/website-audit.md](../02-current-state/website-audit.md) §8 (96 blog posts, 55 dictionary terms, 23 trade pages, 6 tutorials, 4 case studies, core pages) and <../../research_notes/Quotr GEO AEO strategy audit/quotr_onsite_content_audit.md>.
