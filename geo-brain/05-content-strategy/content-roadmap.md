...
5. **One page per real question, not per wording.** Google warns that pages made for every query variation can count as scaled content abuse (verification file, claim 2). Several prompts share one page on purpose.
...
## The topic clusters (hubs)

A cluster is one strong pillar page plus the pieces that support it, linked to each other. AI engines and people should be able to land on any piece and find the rest.

| # | Cluster | Pillar page (proposed) | Why this cluster | Pieces |
|---|---|---|---|---|
| 1 | **Procurement, tariffs and landed cost** | R-08 "What is factory-direct construction procurement?" + [/procurement/](https://quotr.ai/procurement/) | Tariff, importing and factory-direct questions cite **no software vendor** today; Quotr's unique mix (white space #1–#2) | R-07, R-08, R-09, R-10, R-11, R-12, R-13, R-20, R-27, R-30, R-31, R-59, R-62 |
| 2 | **Original data ("Quotr.ai Cost Data")** | R-19 data hub (proposed URL /data/, **TO CONFIRM**) | Primary research earns about 3.3× more citations per page (Growth Memo); Quotr's numbers exist only as claims today | R-19, R-29, R-38, R-40, R-41, R-51 |
| 3 | **Cost guides** | Linked from the data hub | Small vendors (Meltplan, Exayard) get cited next to RSMeans; LA-rebuild question cites no vendor (white space #3, #6) | R-21, R-32, R-48, R-55 |
| 4 | **By persona** | Four hubs | Quotr was absent from every persona prompt tested (C2, C8, C13; S1, S2) | R-14, R-22, R-34, R-60, R-54 |
| 5 | **By trade** | R-46 trades hub at /software/trades/ | Trade pages are thin (drywall: about 25 unique words); no rival pairs trade pages with material prices (white space #8) | R-23, R-24, R-43, R-44, R-45, R-46, R-56, R-57, R-58 |
| 6 | **Estimating how-tos** | Existing guides; Estimating 101 hub later (backlog) | Quotr's how-tos already get cited, unnamed (P5, N2) | R-06, R-33, R-49, R-53 |
| 7 | **Comparisons** | R-35 comparison hub | "X vs Y" searches show an AI Overview 95.4% of the time (Seer); keep 5–8 honest head-to-heads | R-04, R-18, R-25, R-35, R-36, R-47 |
| 8 | **Glossary** | [/dictionary/](https://quotr.ai/dictionary/) | Deepen the terms tied to Quotr's strengths; add procurement terms | R-28, R-50 |
| 9 | **Proof and trust** | [/case-studies/](https://quotr.ai/case-studies/) + [/about-us/](https://quotr.ai/about-us/) | Engines call Quotr's claims "vendor assertions"; accuracy and security are contractors' top AI worries | R-01, R-02, R-03, R-15, R-16, R-26, R-37, R-42, R-61 |
| 10 | **Outsourced estimating (Quotr Service)** | Rebuilt outsourced-estimating page (R-05) | Quotr's page is the first citation for service pricing, unnamed (C12) | R-05, R-52 |
| 11 | **Company news and press** | Blog "Product updates" hub | No seed-round press release; conflicting funding figures | R-17, R-39 |
| 12 | **Video** | [@QuotrAI](https://www.youtube.com/@QuotrAI) channel, embedded on matching pages | YouTube is the largest single source domain for SaaS in AI answers (Aleyda Solis, Aug 2026) | V-01 to V-06 |

---

## Master list, by cluster

### Cluster 1: Procurement, tariffs and landed cost
...
| R-62 | "How to check the quality of building materials from overseas factories: audits, inspections and samples" | How-to guide (+ V-03) | L-121, D-042 | TOFU | BUY, DEV / SRC | Quotr's audit and QC process (photos and process **TO CONFIRM**) | P3 | Mar 2027 |

### Cluster 2: Original data ("Quotr.ai Cost Data")
...
| R-41 | "2026 AI Takeoff Accuracy Benchmark: residential and multifamily plan sets" + "How we test" method page | Data report + method page | L-035 (T30), L-039, L-040, L-041, D-019, E-088 | TOFU / BOFU | SUB, GC, DEV / GEN | Internal benchmarking made public: vector vs scanned plans, items measured, error rates, time saved; invite an outside reviewer (a university program, **TO CONFIRM**); answers engines calling "95–99%" self-published | P1 | Feb 2027 |
| R-51 | "Factory-Direct vs US Dealer Price Index, Q1 2027" | Data report | As R-19 | TOFU / MOFU | As R-19 | Second edition shows the trend; press hook | P1 | Mar 2027 |

### Cluster 3: Cost guides

| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-21 | "Cost to rebuild a house in Los Angeles after the fires (2026): a line-item example" | Cost guide | L-134 (T47) | TOFU | RES, DEV / GEN | Quotr's "Fast Cost Estimation (Residential LA Fire Rebuilding)" sample deliverable and its free FireTips app (Feb 2025); today the answer cites Bloomberg and local GCs only | P1 | Dec 2026 |
| R-32 | "Kitchen cabinet cost per linear foot: factory-direct vs dealer vs RTA (2026)" + cabinet-run calculator | Cost guide + calculator | L-088, L-086, L-085, E-038 | TOFU | RES, DEV / CAB | Quotr procurement cabinet prices (**TO CONFIRM**); no competitor has a cabinet trade page | P2 | Jan 2027 |
| R-48 | "AI takeoff and estimating prices in 2026: per seat, per sheet, per project and per sq ft" | Cost guide | E-054 (T22), E-074 (T44), E-073 (T12), D-009 | MOFU | SUB, SVC / GEN | A dated market price table with sources, including Quotr.ai Lite at $79.90 per seat per month and the Service at $0.25/$0.10 per sq ft (Lite was never mentioned for "cheapest AI takeoff software") | P2 | Feb 2027 |
| R-55 | "California residential build costs 2026: cost per sq ft for a house and an ADU, by finish level (Bay Area data)" | Cost guide | L-132, L-133 | TOFU | RES, DEV / GEN | Bay Area procurement projects and Quotr estimates; factory-direct vs dealer finish costs (**TO CONFIRM**) | P2 | Mar 2027 |

### Cluster 4: By persona

| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-14 | "Quotr.ai for residential builders and small GCs: plans → takeoff → proposal → factory-direct finishes" | Persona hub | E-002 (T02), E-008 (T13), E-010, E-014, E-063 | MOFU | RES / GEN | The only workflow that ends in a factory-direct purchase; residential proof; fair links to the Handoff and Buildxact comparisons | P1 | Nov 2026 |
| R-22 | Rebuild [/developers/](https://quotr.ai/developers/) into "Quotr.ai for multifamily and real estate developers" | Persona hub | E-005 (T08), E-011, E-087, E-023 | MOFU | DEV, FUND / GEN | Estimation Service at $0.10 per sq ft above 50,000 sq ft; pro formas; finish packages per unit; developer customers (BiltWise, **TO CONFIRM**) | P1 | Dec 2026 |
| R-34 | Rebuild [/contractors/](https://quotr.ai/contractors/) into "Quotr.ai for trade subcontractors" | Persona hub | E-001 (T01), E-014, E-018 | MOFU | SUB / all trades | Per-trade workflows, per-seat pricing, RL Electric proof, bid-to-GC flow | P2 | Jan 2027 |
| R-54 | "Development pro forma material budget template" (free download) | Template download | L-138, E-022 | TOFU | DEV / GEN | Built from the format of Quotr's pro forma deliverables | P3 | Mar 2027 |
| R-60 | "Quotr.ai for GC preconstruction teams: AI takeoff, supplier-price comparison and on-demand estimating" | Persona hub | E-016, E-004 (T07), E-079, E-021 | MOFU | GC / GEN | On-demand Service when the bid pipeline spikes; bid-leveling features **TO CONFIRM** | P3 | Mar 2027 |

### Cluster 5: By trade

| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-23 | Deep electrical trade page: "AI takeoff for electrical contractors: devices, runs and panel schedules from PDF plans" | Trade page + V-01 | E-028 (T06), L-094, L-092, D-034 | MOFU | SUB / ELEC | RL Electric result (about 20 hours to 1–2 hours per takeoff), residential and commercial examples, a sample output | P2 | Dec 2026 |
| R-24 | Drywall bundle: deep drywall page + "How to estimate drywall for a house" + free drywall calculator | Trade page + how-to + calculator | E-026 (T04), L-047 (T27), L-048, L-051 | TOFU / MOFU | SUB, RES / DRY | Quotr takeoff on a real residential plan; calculators won P2 for three rivals | P2 | Dec 2026 |
| R-43 | Deep HVAC trade page + residential HVAC estimating section | Trade page | E-030 (T50), L-102, L-103, L-104 | MOFU | SUB / HVAC | Quotr's HVAC sample deliverable plus a residential example | P2 | Feb 2027 |
| R-44 | Deep plumbing trade page + "plumbing price per fixture for new construction" section | Trade page | E-029, L-097 (T49), L-098, L-101 | MOFU | SUB / PLMB | Quotr's plumbing how-to is already the first citation for N2; fixture package prices (**TO CONFIRM**) | P2 | Feb 2027 |
| R-45 | Flooring bundle: deep flooring page + flooring waste-factor calculator + "LVP vs tile vs engineered hardwood: cost for a new build, factory-direct vs retail" | Trade page + calculator + cost guide | E-027 (T05), L-057, L-059, L-060, L-061 | TOFU / MOFU | SUB, RES, DEV / FLR | Factory-direct flooring price ranges (**TO CONFIRM**) | P2 | Feb 2027 |
| R-46 | Trades hub at /software/trades/: all 23 trade workflows on one strong page | Trade page (hub) | E-026 to E-042, D-034 | MOFU | SUB / all | Honest scope per trade; replaces the thin pages that are noindexed or merged | P2 | Feb 2027 |
| R-56 | "How to estimate a lumber package for a new house" + framing page rebuild | How-to + trade page | L-052 (T53), L-054, E-032 | TOFU / MOFU | RES, SUB / FRM | Quotr framing takeoff example; lumber tariff note (AGC: lumber and plywood up 9.9% year on year by July 2026, per the prompt library) | P3 | Mar 2027 |
| R-57 | "How to do a roofing takeoff from plans for new construction" + roofing page rebuild | How-to + trade page | L-074, L-073, E-033 (T51) | TOFU / MOFU | SUB / ROOF | Plan-based takeoff where aerial reports struggle (new construction); Quotr roofing sample deliverable | P3 | Mar 2027 |
| R-58 | "Window and door schedule takeoff to purchase order" + glazing and doors-and-hardware page rebuilds | How-to + trade page | L-081, L-084, E-037 | TOFU / MOFU | SUB, RES, DEV / WIN | Takeoff straight into a factory quote with landed cost | P2 | Mar 2027 |

### Cluster 6: Estimating how-tos

| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-06 | Rebuild: "Is AI takeoff accurate? What Quotr.ai's testing shows" ([post](https://quotr.ai/blog/is-ai-takeoff-actually-accurate-yet/)) | How-to guide | L-035 (T30), L-039, L-041, D-019 | TOFU | SUB, GC / GEN | Brand-attached figures ("In Quotr.ai's internal testing, 94–99% on clean vector sets, lower on scans"); already the first citation for P5, unnamed | P1 | Oct 2026 |
| R-33 | "How to level subcontractor and supplier bids for a home build" + free bid-leveling spreadsheet, with a "from leveled bid to purchase order" section | How-to + template download | L-014, L-015, L-016, E-012 (T41), E-066, E-067 | TOFU / MOFU | GC, RES / GEN | Quotr's bid-comparison-to-procurement flow; scope-gap checklist from Junzhe Shi, PhD's post | P1 | Jan 2027 |
| R-49 | Rebuild: "Can ChatGPT do a construction takeoff? We tested it on a real plan (dated test)" ([post](https://quotr.ai/blog/chatgpt-for-construction-estimating/)) | How-to guide | L-037, E-069 | TOFU | SUB, RES / GEN | A dated, side-by-side test on a real plan set, with honest limits of both | P3 | Feb 2027 |
| R-53 | "How to estimate a multifamily project from schematic plans (worked example)" | How-to guide | L-129 (T28), L-136, L-137 | TOFU | DEV / GEN | An anonymized Quotr estimate walk-through: unit mix → quantities → cost (**TO CONFIRM**) | P2 | Mar 2027 |
...
| R-36 | "Quotr.ai vs Buildxact" | Comparison page | D-030, E-052, E-060 | MOFU / BOFU | RES / GEN | Buildxact's dealer pricing vs Quotr's factory-direct; dated facts | P2 | Jan 2027 |
| R-47 | "Quotr.ai alternatives: when to choose something else" | Alternatives page | D-023 (T40) | BOFU | ALL | Honest fit guide; today about 10 of 18 sources for this prompt are Quotr's own posts | P2 | Feb 2027 |

### Cluster 8: Glossary

| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-28 | Glossary deepening batch: AI takeoff, quantity takeoff, bid leveling, markup vs margin (formula and worked example), change order (pricing steps), scope gap | Glossary term (rebuild) | L-033, L-030, L-014, L-004, L-005, L-024, L-011 | TOFU | ALL / GEN | Named reviewer, sources, examples linked to Quotr data and tools | P3 | Dec 2026 |
| R-50 | New procurement terms: landed cost, FOB, HTS code, ISF filing, customs broker, NFRC, CARB, cUPC (check whether a DDP term already exists) | Glossary term | L-110, L-115, L-117, L-082, L-090, L-101 | TOFU | BUY, DEV / SRC | Written from Quotr's import practice; supports cluster 1 | P2 | Feb 2027 |

### Cluster 9: Proof and trust
...
| R-37 | "Security and data: how Quotr.ai handles your drawings and bids" | Proof page | E-071 | BOFU | GC, SUB / GEN | SOC 2 status, encryption, data ownership, model-training policy (**TO CONFIRM**); security is a top worry for 54% of contractors (Dodge/CMiC) | P2 | Jan 2027 |
...
| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-05 | Rebuild: "Outsourced construction estimating: prices, turnaround and what you get (2026)" ([post](https://quotr.ai/blog/outsource-construction-estimating/); absorbs construction-estimating-services) | How-to guide | E-073 (T12), E-080, L-018, L-019, D-012 | MOFU | SVC, DEV, GC / GEN | "Quotr.ai's Estimation Service charges $0.25 per sq ft under 50,000 sq ft and $0.10 above"; one agreed turnaround; a sample deliverable ("All Trade Takeoff (Residential)") | P1 | Oct 2026 |
| R-52 | "Quotr Service by the numbers: turnaround by project size, volume and how we count $1.2B+" | Data report + proof page | L-006 (T32), L-007, L-046, D-046 | TOFU / BOFU | SVC, DEV, GC / GEN | Service job data with method (**TO CONFIRM**); turns "$1.2B+" and "300+ projects a month" into checkable numbers | P2 | Mar 2027 |
...
| V-05 | Episodes 7–8: windows and doors, cabinets (takeoff to factory quote) | Video | L-081, L-088 | TOFU / MOFU | RES, SUB / WIN, CAB | Shows the takeoff-to-purchase flow only Quotr has | P2 | Mar 2027 |
| V-06 | "Where AI takeoff still fails: scanned plans" (honest test) | Video | L-039, L-041 | TOFU | SUB / GEN | Honest limits build trust with skeptical estimators (r/estimators threads) | P3 | Mar 2027 |

**Count:** 62 written pieces (R-01 to R-62) + 6 video items (V-01 to V-06) = **68 roadmap items**. Of these, 28 are P1.
...
| **Feb 2027** | R-40, R-41, R-42, R-43, R-44, R-45, R-46, R-47, R-48, R-49, R-50; V-04 (12) | Two big datasets (cost per sq ft; accuracy benchmark); trade depth | Service data export and method; accuracy test run (and outside reviewer if used) |
| **Mar 2027** | R-51, R-52, R-53, R-54, R-55, R-56, R-57, R-58, R-59, R-60, R-61, R-62; V-05, V-06 (14) | Second price-index edition; developer and California cost guides; remaining trades; review hub if reviews exist | Q1 price data; 10+ real reviews for R-61 |

**Pace:** about 7–12 written pieces a month plus about 2 videos, compared with 22–25 posts a month at the May–June 2026 peak. Several items are rebuilds of existing URLs or small glossary batches. If capacity is short, drop P3 items first (they are marked above), never the quality bar.

---

## Launch kit for every data asset (R-19, R-29, R-38, R-40, R-41, R-51, R-52)

Each dataset is only worth the effort if other people see it. For each one:
...
7. **Community post** where it genuinely helps (for example, r/estimators for the accuracy benchmark), with clear disclosure.
8. **Add the prompts** it targets to the monthly tracking and check again 4–8 weeks later.

---

## Dependencies: data and decisions needed from Quotr

| Needed from Quotr | Blocks | By |
|---|---|---|
| Approved fact sheet (price wording, factory count, savings, turnaround, HQ, founders, funding, audience, handles) | Everything; especially R-01, R-02, R-05, R-17 | Early Oct 2026 |
| Procurement: categories supplied, delivery area, whether aggregated quote data can be published | R-08, R-09, R-11, R-16, R-19, R-20, R-30, R-31, R-32, R-45, R-51, R-58 | Nov 2026 |
| Customer permissions and numbers (RL Electric, AlphaX, BiltWise Structures, Salisbury Moore; Saratoga client) | R-15, R-16, R-42 | Nov 2026 |
| Service job data (sq ft, trade costs, turnaround timestamps) and a method owner | R-40, R-52, R-53, R-55 | Jan 2027 |
| Accuracy benchmark design and test run; optional outside reviewer | R-41 | Jan 2027 |
| Security, integrations, file formats, browser/Mac support | R-18, R-26, R-37 | Nov–Dec 2026 |
| A customs or trade expert to review tariff and certification pages | R-10, R-12, R-29, R-30 | Nov 2026 |
| Developer time for calculators (landed cost, drywall, cabinet run, flooring) | R-20, R-24, R-32, R-45 | Dec 2026–Feb 2027 |
| Video capacity (who films, edits, appears on camera) | V-01 to V-06 | Nov 2026 |

---

## Backlog after March 2027 (not counted)

Quotr.ai vs Kreo (D-031, E-049); tile calculator and tile page (L-062, L-065); concrete calculator (L-069); "Estimating 101" learning hub (L-002, L-027); overhead-and-profit guide for subs (L-003); a cost-review service page for lenders and funds (E-086, L-141); developer glossary terms (hard vs soft costs, contingency, estimate classes: L-135, L-137, L-142); "What you get for $0.25 per sq ft" deliverable walk-through (D-047); Q2 2027 price index; H1 2027 cost benchmark; 2027 accuracy benchmark.
