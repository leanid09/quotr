...
| ID | Working title | Format / template | Target prompts | Funnel | Persona / trade | Unique Quotr data or angle | Priority | Month |
|---|---|---|---|---|---|---|---|---|
| R-06 | Rebuild: "Is AI takeoff accurate? What Quotr.ai's testing shows" ([post](https://quotr.ai/blog/is-ai-takeoff-actually-accurate-yet/)) | How-to guide | L-035 (T30), L-039, L-041, D-019 | TOFU | SUB, GC / GEN | Brand-attached figures ("In Quotr.ai's internal testing, [approved %] on clean vector sets, lower on scans"). Use one approved figure: Perplexity summarized this post as "94–99%", while other Quotr pages say "95–99%" (**TO CONFIRM with Quotr**); already the first citation for P5, unnamed | P1 | Oct 2026 |
