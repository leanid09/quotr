...
AI tools already show the damage:
...
| Funding | $200K pre-seed + $3.5M seed (/disambiguation/) vs "raised $5 million" (MPN podcast) vs one undated-amount seed round (PitchBook) |
| Investors | SkyDeck + Llama Ventures vs + Sky Arc Capital (PitchBook) |
| Employees | 11–50 vs 10 (PitchBook) |
| Factory network | 50+ vs 220+ vs 30+ |
...
- **Treat "Wikipedia hacks" with caution.** The March 2026 podcast episode with Quotr's CEO listed "The Wikipedia Hack" as a topic (offsite notes §3). Any undisclosed or promotional editing risks deletion, reputational damage and a permanent record on the article's talk page.
...
- **Context:** Wikipedia was a very large share of ChatGPT's top-cited sources in 2024–25 data (Profound: 47.9% of its top-10 source share), but ChatGPT's Wikipedia citations dropped sharply in September 2025; treat that figure as historical (`verification_geo_evidence.md` O4).
