...
| Associations | Member of BIA Bay Area and the Modular Building Institute directory | Offsite notes §3 |
...
|---|---|---|---|
| **Associations** | BIA Bay Area and Modular Building Institute (member); NAHB; NMHC | Member resources, event talks, co-published data on association sites (strong authority for tariffs and multifamily questions) | Ask BIA and MBI about member content slots, webinars, or a data briefing |
