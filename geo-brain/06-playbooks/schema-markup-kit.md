...
Example for /software/ (the first answer is the live /software/ FAQ text as scraped on 2026-09-25; the second must be added to the visible FAQ first):
...
**Purpose:** describe an embedded video so search engines can show it. YouTube is a heavily cited source in Google AI Overviews (see [offsite/youtube-and-video.md](offsite/youtube-and-video.md)); marking up the videos Quotr embeds on its own pages is low effort.
