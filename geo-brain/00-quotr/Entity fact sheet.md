---
type: fact-sheet
description: The single source of truth for Quotr facts, with confidence labels, profiles, naming rules, a 31-row contradiction register and draft boilerplate.
aliases:
- Fact sheet
- Quotr facts
...
> The one place to check "what is true about Quotr.ai": names, company facts, numbers, official profiles, naming rules, known contradictions and approved-draft boilerplate text.

> [!info]- Sources
> [[quotr_onsite_content_audit]], [[quotr_offsite_presence]], [[verification_quotr_and_competitors]], [[quotr_ai_visibility_tests]], [[competitor_geo_benchmark]]; live pages on quotr.ai (/, /pricing/, /software/, /service/, /procurement/, /faq/, /about-us/, /disambiguation/, /terms, /llms.txt); search-index text of quotr.ai pages checked with WebSearch on 2026-09-25; /pricing/, /software/ and /about-us/ re-read directly with a scraper on 2026-09-25; Crunchbase, PitchBook, Product Hunt, F6S, SkyDeck and Llama Ventures pages (as recorded in the notes).
...
| Older product names | "Quotr Estimate" (Revit extension), "Quotr Assist", "Quotr Connector (automatic sync with Autodesk Revit)" | [F6S listing](https://www.f6s.com/software/quotr); YouTube video "How To Use Quotr Estimate \| Cost Estimation Revit Extension" ([video](https://www.youtube.com/watch?v=zNIXcvCbWAg)) | Medium | These describe the 2024-era Revit/architect product. Whether the Revit add-in is still sold is **TO CONFIRM with Quotr** (see [[Products and features]]). |
| Legal entity | **FLOZ Inc.** (Delaware corporation, doing business as "Quotr") | [quotr.ai/terms](https://quotr.ai/terms): "FLOZ INC., a Delaware corporation with offices at 495 27th Ave Unit 8, San Francisco, CA 94121" (read directly in the verification file, Gaps filled #1); the "doing business as 'Quotr'" wording comes from search-index text of the same page (WebSearch, 2026-09-25); `legalName: "FLOZ Inc"` in /disambiguation/ schema; F6S "Made by FLOZ" | High | The homepage and /software/ schema wrongly say `legalName: "Quotr.ai"` (onsite audit §3). Crunchbase lists legal name "Quotr". |
...
| Company values (self-stated) | Trust, Accuracy, Empowerment, Ownership. Accuracy is defined as "Every figure traces to a real source — no dressed-up assumptions." | /about-us/ (live) | High | Useful as a house rule for marketing copy too: several public claims do not yet meet this standard (see [[Positioning and proof points]]). |
...
| Crunchbase | https://www.crunchbase.com/organization/quotr | Yes (name "Quotr.ai") | **HQ is stated both ways on the same page:** the location field and FAQ say Berkeley, while the About text says "Founded in 2023 and headquartered in San Francisco" (both confirmed by reading the page; verification file, claim 20 and contradiction 7). The About text is written in Quotr's own voice ("from our own in-house cost estimators"), so Quotr can edit it. A search-index snippet of the page (WebSearch, 2026-09-25) instead shows "headquartered in Berkeley, CA", calls the product "Agentic AI", and claims "reduce material costs by up to 50% and cut estimation time by 90%" (snippet only, not seen on the page). The page also says "50+ vetted factories … 40–55% below distributor markup". Search summaries still describe Quotr as "an AI assistant providing real-time cost estimation and Revit integration to help architects". |
...
|---|---|---|---|---|
| 1 | Software pricing | Lite $79.90 / Plus $299.90 / Enterprise custom (/pricing/, /software/, /disambiguation/). "1 User Plan $299.90/mo; 2–10 Users Plan $499.90/mo" (llms.txt). "Solo $299.90; Team (2–6 seats) $499.90; Enterprise (7+)" (about 13 Quotr URLs in total: mostly blog posts, plus the indexed /contractors copy). "Software from $299.90/month" (Togal-alternatives post). Third parties copying the old price: Nomic ("From ~$299.90/month") and Octopus Builds (Solo/Team). | Lite $79.90, Plus $299.90 per seat per month; Enterprise custom; 7-day free trial | llms.txt; /contractors/; the blog posts listed in the verification file (Gaps filled #2) and in [[GEO tactics already used]] (tactic 26), e.g. [stack-alternative](https://quotr.ai/blog/stack-alternative/), [ai-bidding-software-construction](https://quotr.ai/blog/ai-bidding-software-construction/), [ai-construction-estimating-software-buyers-guide](https://quotr.ai/blog/ai-construction-estimating-software-buyers-guide/); ask Nomic and Octopus Builds to update. |
...
| 17 | Legal name in schema | `legalName: "Quotr.ai"` (homepage, /software/) vs `"FLOZ Inc"` (/disambiguation/) under the same `@id` | `name: "Quotr.ai"`, `legalName: "FLOZ Inc."` on every page | Site-wide Organization schema (see [[Schema markup kit]]) |
...
- [[Products and features]] — every module, what it does and who it is for
- [[Audiences and personas]] — who buys Quotr and what they ask AI tools
- [[Positioning and proof points]] — differentiators, proof and risky claims
- [[Website audit]] — on-site issues in detail
- [[Off-site presence]] — third-party profiles and mentions
- [[Schema markup kit]] — how to fix the Organization schema
- [[AI visibility baseline]] — how AI tools describe Quotr today, prompt by prompt
- [[Meeting brief]] — short briefing for the Quotr meeting
- [[AI context pack]] — a condensed version of this page's High-confidence facts and naming rules, for pasting into AI tools
- [[QA log]] — the consolidated TO CONFIRM list (questions to ask Quotr)
