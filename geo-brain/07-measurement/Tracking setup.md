...
- **llms.txt:** expect few or no AI-bot requests. An Ahrefs study of 137K domains reportedly found 97% of llms.txt files got no requests in a month (not re-checked by the fact-check) ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).
...
| **Monthly** (first week) | Half a day (Lite) to 2 days (Standard, by hand) | Full prompt test (§7); Search Console Generative AI report and branded search; Bing AI Performance; GA4 AI channel and landing pages; form answers; reviews and list inclusions; crawler health; re-score [presence-scorecard.md](../02-current-state/presence-scorecard.md) | Monthly dashboard ([kpis-and-dashboard.md §6](kpis-and-dashboard.md)) plus the 5-line note |
| **Quarterly** | 1 day | 3-month trends by engine, including the presence-scorecard trend; Claude and Copilot runs; branded-search trend; AI vs organic conversion comparison; swap in up to 5 new prompts ([tracking-set.md §5](../04-prompt-library/tracking-set.md)); update the GA4 regex with new AI sources; review tool choice and budget ([tools-comparison.md](tools-comparison.md)); review targets | Quarterly review deck or doc for Quotr leadership |
