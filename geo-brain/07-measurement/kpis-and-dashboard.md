...
**What this page is for:** The numbers Quotr uses to judge whether its GEO/AEO work is paying off. It covers what each number means, where it comes from, its September 2026 starting value, suggested 90-day and 6-month targets, and a one-page dashboard to fill in every month.

**Last updated:** 2026-09-25

**Sources:** Final report <../../reports/Quotr GEO AEO strategy audit.md> (measurement section, six-number scorecard, 90-day plan). Research notes <../../research_notes/Quotr GEO AEO strategy audit/quotr_ai_visibility_tests.md> (baseline, §5), <../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md> (§4 measurement, §5 case studies, §7 top of funnel), <../../research_notes/Quotr GEO AEO strategy audit/geo_ai_citation_signals_2026.md> (§4–5 traffic), <../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md> (claims 3, 6, 7, 21, 24; H1, H14; M1, M8; O5) and <../../research_notes/Quotr GEO AEO strategy audit/verification_quotr_and_competitors.md>. Brain files [../02-current-state/ai-visibility-baseline.md](../02-current-state/ai-visibility-baseline.md), [../02-current-state/presence-scorecard.md](../02-current-state/presence-scorecard.md), [../02-current-state/offsite-presence.md](../02-current-state/offsite-presence.md), [../04-prompt-library/tracking-set.md](../04-prompt-library/tracking-set.md), [../01-geo-fundamentals/traffic-and-funnel-impact.md](../01-geo-fundamentals/traffic-and-funnel-impact.md).
...
- **Where Quotr starts (September 2026, Perplexity only):** named in **1 of 32** unbranded buyer questions (3.1%). Share of voice about **0.7%**, against about 6.5% each for STACK, PlanSwift and Buildxact. **5 of 8** branded answers contained an error. AI engines already read Quotr's pages (quotr.ai was in the source list for 6 of 32 answers), but they drop the name.
...
| **L3** | **Mention rate on unbranded prompts** | Unbranded prompts where Quotr is named ÷ unbranded prompts run. Report **per engine** | Monthly prompt tracking ([tracking-set.md](../04-prompt-library/tracking-set.md)) | Monthly | **3.1%** (1 of 32). By type: category discovery 0 of 15; comparison 1 of 9 ("Togal.AI alternatives", about 15th of 17 brands); how-to 0 of 8. Other engines: **no baseline yet** |
| **L4** | **"Cited, not named" converted** | Of the prompts where a quotr.ai page is a source but Quotr is not named, how many now name Quotr? | Monthly prompt tracking | Monthly | **3 prompts cited, not named** in the core set: C12 outsourced estimating price, V3 PlanSwift alternatives, P5 AI takeoff accuracy. Plus N2 plumbing estimating in the extension set ([tracking-set.md](../04-prompt-library/tracking-set.md)). Converted: 0 |
| **L5** | **Share of voice vs named competitors** | Count each brand once per prompt when named. Quotr's count ÷ all brand mentions across the unbranded prompts | Monthly prompt tracking (or a tool, see [tools-comparison.md](tools-comparison.md)) | Monthly | **~0.7%** (1 of ~153 mentions). STACK, PlanSwift, Buildxact ~6.5% each; Togal.AI ~5.2%; Procore, Bluebeam, Kreo ~4.6% each |
| **L6** | **Accuracy of branded answers** | Brand prompts with at least one error from the checklist ÷ brand prompts run | Monthly prompt tracking; checklist in [tracking-set.md §3.6](../04-prompt-library/tracking-set.md) | Monthly | **5 of 8** had errors: stale "from $299.90" price (B4, V2); the unrelated Quotr Pro app's 37 ratings / 4.7 used as Quotr's (B3); Quotr listed 3rd of 4 "Quotr" apps (B5); funding conflict including a "$190K seed" figure (B6). "Quotr.ai pricing" (B2) was right but cited the staging site test.quotr.io |
...
| **L8** | **Third-party list inclusions** | Number of independent "best of", comparison or directory pages that name Quotr. Count separately: (a) any page; (b) pages AI engines cite repeatedly (list in [citation-sources-map.md](../03-market/citation-sources-map.md)) | Monthly prompt tracking ("3rd-party pages naming Quotr" field); manual checks | Monthly | (a) **3 pages**, none independent editorial: Nomic (Quotr 5th of 7; Nomic ranks itself first), Octopus Builds (2nd of 8; author ranks itself first; repeats old $299.90 price), ForesightIQ (sourced only from Quotr's blog). (b) **0**: not on Construction Coverage, The Digital Project Manager, ConstructConnect's 2026 guide, ContraVault or ConstructionPlacements |
| **L9** | **Fact consistency** | Count of Quotr-controlled URLs and profiles showing a retired or conflicting fact (price, HQ, funding, founders, factory count) | Site crawl or search; [entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md) | Monthly until zero, then quarterly | Old Solo/Team pricing on **about 13 Quotr URLs** plus llms.txt and the indexed /contractors copy. HQ, funding, founders and factory count each appear in 2–3 versions ([report](<../../reports/Quotr GEO AEO strategy audit.md>)) |
| **L10** | **Off-site mentions** | New trade-press articles, YouTube videos and views, Reddit threads, LinkedIn articles that name Quotr | Google Alerts, YouTube Studio, manual search | Monthly | No trade-press coverage; no press release for the seed round; no Reddit threads found; YouTube channel exists but was **never cited** in 45 test runs; one marketing podcast episode (March 2026) ([offsite-presence.md](../02-current-state/offsite-presence.md)) |

### 3.2 Lagging KPIs (business results)

| # | KPI | How to measure it | Tool / source | How often | September 2026 baseline |
|---|---|---|---|---|---|
| **G1** | **AI referral sessions** | Sessions from AI tools, by source (ChatGPT, Perplexity, Gemini, Copilot, Claude and others). Also as a share of all sessions, and by landing page | GA4 native "AI Assistant" channel **plus** a custom channel rule that also catches Perplexity ([tracking-setup.md §1](tracking-setup.md)) | Weekly glance, monthly report | **TO CONFIRM with Quotr.** A custom GA4 channel group can be applied to past data, so the January–September 2026 history can be pulled on setup day. Outside reference only: Conductor put AI referrals at about 1.08% of all website traffic for enterprise sites (2025 data; not re-checked) |
...
**Why lagging numbers need care:** a buyer who reads "Quotr.ai" in a ChatGPT answer often searches the name later or types the URL. Analytics then records branded search or direct traffic, not AI. That is why G3 and G4 matter as much as G1 ([traffic-and-funnel-impact.md](../01-geo-fundamentals/traffic-and-funnel-impact.md)). Also, clicks from Google AI Overviews and AI Mode arrive as ordinary Google organic traffic in GA4; only Search Console shows AI impressions, and it shows no AI clicks ([report](<../../reports/Quotr GEO AEO strategy audit.md>); [tracking-setup.md §2](tracking-setup.md)).

### 3.3 The report's six-number top-of-funnel scorecard

The report recommends tracking these six numbers every month as the simple view of top-of-funnel reach ([report](<../../reports/Quotr GEO AEO strategy audit.md>)). They map onto the KPIs above.
...
Keep total website sessions on the dashboard too, but not as the only top-of-funnel measure. AI summaries take clicks from educational pages, so traffic can fall while reach grows ([traffic-and-funnel-impact.md](../01-geo-fundamentals/traffic-and-funnel-impact.md)).
...
| L4 | "Cited, not named" converted | 0 of 3 (plus N2) | At least 2 of C12, V3, P5 name Quotr | All 4 (C12, V3, P5, N2) name Quotr | Directly tests the "make the name part of the fact" fix ([geo-writing-style-guide.md](../06-playbooks/geo-writing-style-guide.md)) |
| L5 | Share of voice (Perplexity, core 32) | ~0.7% | **~2% or more** (about 3 mentions) | **~3.5–4% or more** (about 5–6 mentions), close to Procore, Bluebeam and Kreo today (~4.6%) | Consistent with the mention-rate targets; STACK-level SOV (~6.5%) needs a large review and list footprint |
...
| L7 | G2 reviews | ~0 (reported) | **10 or more genuine reviews** | **25–30 reviews**; Capterra / GetApp / Software Advice listings live under "Quotr.ai" | The report's review-drive goal is 10–30 honest reviews under G2's rules. Target the **count**, never the rating; ask all real customers, not only happy ones ([myths-and-risks.md](../01-geo-fundamentals/myths-and-risks.md)) |
...
| L10 | Off-site mentions | No press, no Reddit, YouTube never cited | At least 1 trade-press pitch sent with the first dataset; founder posts started; YouTube series planned | At least 2 independent articles; YouTube series live; disclosed founder answers in r/estimators | Supports L3 and L5; proof from others is the main signal ([signals-that-matter.md](../01-geo-fundamentals/signals-that-matter.md)) |
...
**About bigger numbers you may hear.** Vendor case studies report fast jumps, such as Ramp's AI visibility rising from 3.2% to 22.2% in one month. That figure is Profound's own metric on Profound's own prompt set, from March 2025, and is a vendor case study, not a benchmark ([verification H14](<../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>)). No public GEO case study with numbers exists for construction tech ([playbook §5](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)). The targets above are deliberately modest.
...
| **Look at 3-month trends, not single months** | Profound (a vendor) reports 40–60% of cited domains change month to month for the same question. A separate study found only about a third of cited pages were still cited 28 days later ([report](<../../reports/Quotr GEO AEO strategy audit.md>)) |
| **Run key prompts twice** | In the September tests, the source list stayed the same between runs but the order of brands changed. Position is noisy ([ai-visibility-baseline.md §7](../02-current-state/ai-visibility-baseline.md)) |
| **Keep the prompt wording fixed** | Changing words changes answers. Add new prompts; don't edit old ones ([tracking-set.md §5](../04-prompt-library/tracking-set.md)) |
...
| **Don't add Search Console AI impressions to Web totals** | They are already inside the Web numbers; the AI report is a filtered view ([verification M1](<../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>)) |
| **Treat conversion claims as hypotheses** | Ahrefs saw AI visitors convert far better on its own site, but the only peer-reviewed study (973 online stores) found ChatGPT traffic converted below most traditional channels, with better results for complex products ([verification claim 24, H1](<../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>)). Measure Quotr's own numbers |
...
| Signal | Action |
|---|---|
| Any wanted AI bot gets 403 / challenge responses | Fix Cloudflare settings the same week ([tracking-setup.md §5](tracking-setup.md)) |
...
| A new third-party page names Quotr | Log it in [offsite-presence.md](../02-current-state/offsite-presence.md); check its facts; thank or correct the author |
...
| Presence scorecard overall | 2.1 / 5 ([presence-scorecard.md](../02-current-state/presence-scorecard.md)) |
...
|---|---|---|
| L6 branded accuracy | One fact sheet; fix ~13 stale-price URLs and llms.txt; rewrite /disambiguation/; request re-crawl; ask Nomic and Octopus Builds to update | [../00-quotr/entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md), [../05-content-strategy/optimize-vs-create.md](../05-content-strategy/optimize-vs-create.md) |
| L4 cited, not named | Rewrite key sentences so "Quotr.ai" travels with each fact on pages AI already cites | [../06-playbooks/geo-writing-style-guide.md](../06-playbooks/geo-writing-style-guide.md), [../06-playbooks/page-refresh-checklist.md](../06-playbooks/page-refresh-checklist.md) |
| L3 / L5 mention rate and SOV | Reviews, independent list inclusions, YouTube, community answers, press | [../05-content-strategy/offsite-earned-media-plan.md](../05-content-strategy/offsite-earned-media-plan.md), [../03-market/citation-sources-map.md](../03-market/citation-sources-map.md) |
| L2 pages cited on top-of-funnel topics | Original data (factory-direct price index, cost per sq ft), free calculators | [../05-content-strategy/content-priorities.md](../05-content-strategy/content-priorities.md), [../03-market/white-space.md](../03-market/white-space.md) |
| L1 crawler access | Cloudflare settings, sitemaps in robots.txt, real "last updated" dates | [tracking-setup.md](tracking-setup.md), [../02-current-state/website-audit.md](../02-current-state/website-audit.md) |
| G1–G4 business results | Homepage that converts first-time AI visitors (ChatGPT now links brand names to homepages); clear demo and trial paths; the "How did you hear about us?" field | [../01-geo-fundamentals/traffic-and-funnel-impact.md](../01-geo-fundamentals/traffic-and-funnel-impact.md), [../05-content-strategy/top-of-funnel-strategy.md](../05-content-strategy/top-of-funnel-strategy.md) |
...
- [tracking-setup.md](tracking-setup.md) — step-by-step setup of GA4, Search Console, Bing, crawler logs, forms and the monthly routine
- [tools-comparison.md](tools-comparison.md) — AI visibility tools, prices and the recommended setup for a seed-stage team
- [../04-prompt-library/tracking-set.md](../04-prompt-library/tracking-set.md) — the 53 prompts to re-run every month, with scoring rules and templates
- [../02-current-state/ai-visibility-baseline.md](../02-current-state/ai-visibility-baseline.md) — the full September 2026 baseline
- [../02-current-state/presence-scorecard.md](../02-current-state/presence-scorecard.md) — the 17-area scorecard to re-score each month
- [../01-geo-fundamentals/traffic-and-funnel-impact.md](../01-geo-fundamentals/traffic-and-funnel-impact.md) — why reach is now measured as presence, not just clicks
- [../08-action-plan/30-60-90-plan.md](../08-action-plan/30-60-90-plan.md) — the plan these targets track
- [../00-quotr/entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md) — the correct facts for checking branded answers
