...
- **Profound, Scrunch, Conductor, BrightEdge.** Revisit when AI becomes a measurable source of pipeline (see KPIs G2 "AI-referred demos and signups" and G5 "AI-sourced pipeline" in [kpis-and-dashboard.md](kpis-and-dashboard.md)), or if Quotr hires an agency that already licenses one.
