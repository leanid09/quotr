...
- **On May 13, 2026, GA4 added a native "AI Assistant" channel** to its default channel group. Visits from recognised AI chatbots get the medium `ai-assistant` and appear under that channel ([SEJ](https://www.searchenginejournal.com/google-analytics-adds-ai-assistant-as-default-channel-group/574974/); [verification claim 7](<../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>)).
...
- **It is not retroactive.** It only labels visits from the date Google switched it on for the property ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).
...
5. Save the channel, then **drag it above "Referral"** in the list. Rules run from top to bottom, so a visit is labelled by the first rule it matches ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)). Keep it **below the Paid channels**, so that any future paid ChatGPT ads tagged as paid stay in Paid (our suggestion).
6. Save the group.
7. Use it: in **Traffic acquisition**, change the first column to your new channel group (`Session Quotr channels (with AI)`).

**Good news:** third-party GA4 guides report that **custom channel groups also work on past data**, unlike the native channel ([Swydo](https://www.swydo.com/blog/track-ai-traffic-in-ga4/); [Summit](https://www.summit.co.uk/opinions-news/native-ga4-vs-custom-regex-navigating-the-new-era-of-ai-traffic/)). So Quotr can pull AI referrals for **January–September 2026** on setup day and use them as the G1 baseline in [kpis-and-dashboard.md](kpis-and-dashboard.md). (Not checked in Quotr's own property: TO CONFIRM.)

**Regex A: the core list from the research notes** ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>))
...
- **Landing pages.** Since May 7, 2026, ChatGPT links brand names straight to their homepages, and Profound (a vendor) reports B2B software referrals from ChatGPT up more than 200% after that change ([verification claim 6](<../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>)). Expect the homepage to be a top AI landing page; make sure it explains Quotr to a first-time visitor.
- Key events from AI sources vs organic search (for the G2 KPI).
...
| **Missing referrer** | Visits from AI desktop and mobile apps, in-app browsers, or pasted links can arrive with no referrer and show up as **Direct** ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)) | AI referrals are **undercounted**. Pair GA4 with the self-reported form field (§6) and branded search (§3) |
...
| **Paid ChatGPT ads (if ever tested)** | OpenAI's ads sit next to answers, not inside them ([report](<../../reports/Quotr GEO AEO strategy audit.md>)) | Tag ad links with a paid medium (for example `utm_medium=paid-ai`) so they stay separate from organic AI visits |
...
2. Add a second Domain property for **`quotr.io`**, the old domain. It lets Quotr watch and clean up what is still indexed there: `quotr.io/pricing/`, `firetips.quotr.io` and the staging site `test.quotr.io`, which Perplexity still cited for "Quotr.ai pricing" ([entity-fact-sheet.md](../00-quotr/entity-fact-sheet.md); [website-audit.md](../02-current-state/website-audit.md)).
...
4. Ask the developer to add the blog sitemap to robots.txt and to use real "last updated" dates in the main sitemap (today every page claims it changed "today") ([report](<../../reports/Quotr GEO AEO strategy audit.md>), 30-day action 7).

### 3.2 The Generative AI performance report (monthly)

- **What it is:** a report showing how often Quotr's pages appeared in **AI Overviews, AI Mode** and Discover's AI features. It breaks results down by page, country, date and device. It was announced in June 2026 and reached **all sites worldwide on Aug 31, 2026** ([Google](https://developers.google.com/search/blog/2026/06/gen-ai-performance-reports); [SEJ](https://www.searchenginejournal.com/google-search-console-ai-reports-rolled-out-worldwide/587836/); verification M1).
...
- **Watch for namesakes.** Some "quotr" searches are for other products, such as the Quotr Pro app ([report](<../../reports/Quotr GEO AEO strategy audit.md>)). Look at the top queries and exclude obvious namesake ones (for example add a second filter: Query → doesn't match regex → `quotr pro`).
- The playbook suggests a **quarterly** branded-search trend review ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).

### 3.5 After fixing pages: ask Google to re-read them

After the old Solo/Team pricing is removed from the ~13 affected URLs ([optimize-vs-create.md](../05-content-strategy/optimize-vs-create.md)):
...
- **Copilot is built on Bing's index.** If a page isn't in Bing, Copilot and Bing's AI answers can't use it ([how-ai-engines-choose-sources.md](../01-geo-fundamentals/how-ai-engines-choose-sources.md)).
- **ChatGPT** says it gets some results from "third-party search providers". OpenAI has not said publicly which ones. Bing is often assumed, but that is **not confirmed** ([signals notes §1](<../../research_notes/Quotr GEO AEO strategy audit/geo_ai_citation_signals_2026.md>)). Being well indexed in Bing is cheap insurance either way.
- **Claude** web search is linked to **Brave Search** (Brave is the search provider named in Anthropic's subprocessor list; not confirmed as "the index") ([verification claim 29](<../../research_notes/Quotr GEO AEO strategy audit/verification_geo_evidence.md>)). Brave has no equivalent of Bing Webmaster Tools; a quarterly check of `site:quotr.ai` on [search.brave.com](https://search.brave.com/) is enough.
...
3. Turn on **IndexNow** so Bing hears about changed pages immediately. Quotr already uses Cloudflare, whose free **Crawler Hints** setting sends IndexNow signals: in the Cloudflare dashboard, turn on Crawler Hints (under Caching → Configuration) ([Cloudflare docs](https://developers.cloudflare.com/cache/advanced-configuration/crawler-hints/)). IndexNow is supported by Bing and some other engines, not Google ([how-ai-engines-choose-sources.md](../01-geo-fundamentals/how-ai-engines-choose-sources.md)).
...
- **What it shows:** how many times Copilot and Bing AI answers **cited** Quotr's pages, **which pages**, and the **"grounding queries"**: the search phrases Copilot generated behind the scenes to find content ([signals notes §1](<../../research_notes/Quotr GEO AEO strategy audit/geo_ai_citation_signals_2026.md>); [Bing](https://blogs.bing.com/webmaster/February-2026/Introducing-AI-Performance-in-Bing-Webmaster-Tools-Public-Preview)).
- **Limits:** summary data only. It does not show individual answers, exact user prompts, or why a page was chosen.
- **Each month, export:** total citations, number of cited pages, top 10 cited pages, top 10 grounding queries. Grounding queries are a free source of **real question wording** for [../04-prompt-library/prompt-library.md](../04-prompt-library/prompt-library.md).
...
AI engines can only cite pages their crawlers can fetch. Quotr's robots.txt lets every bot in (`User-agent: *` / `Allow: /`). But the site sits behind **Cloudflare**, which has separate switches that can block or challenge bots. From outside, the research could not see whether they are on ([report](<../../reports/Quotr GEO AEO strategy audit.md>); [website-audit.md](../02-current-state/website-audit.md)). The report lists "Confirm Cloudflare is not blocking AI search bots" as a first-30-days task.

What is known today:
- **Cloudflare AI Labyrinth is on.** Every checked page has a hidden, `nofollow` link to `/cdn-cgi/content?id=…`. It is a trap that leads bots which **ignore crawl rules** into AI-generated decoy pages. It should not affect well-behaved crawlers ([onsite notes §1](<../../research_notes/Quotr GEO AEO strategy audit/quotr_onsite_content_audit.md>); [Cloudflare docs](https://developers.cloudflare.com/bots/additional-configurations/ai-labyrinth/)). Keep it, but confirm it was switched on deliberately.
- **Unknown:** whether Cloudflare's **"Block AI bots"** or **managed robots.txt** settings are on. Because robots.txt has not been rewritten, they are **probably off**, but this is **TO CONFIRM with Quotr** ([onsite notes §1](<../../research_notes/Quotr GEO AEO strategy audit/quotr_onsite_content_audit.md>)).
...
"User-agent" is the name a bot gives when it visits. Recommendations from [how-ai-engines-choose-sources.md](../01-geo-fundamentals/how-ai-engines-choose-sources.md).
...
- **Crawling is not the same as being cited.** Cloudflare-based figures (July 2026, secondary summary) put ClaudeBot at about 2,237 crawls per referral and GPTBot at about 217, against about 4.6 for Google ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)). Lots of bot hits don't mean lots of visits.
...
- **llms.txt:** expect few or no AI-bot requests. An Ahrefs study of 137K domains found 97% of llms.txt files got no requests in a month ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).

---

## 6. "How did you hear about us?" field

Analytics misses much of AI's influence (see §2). Asking people directly catches it. The playbook recommends a **required** field on demo and trial forms, plus tagging AI-sourced deals in the CRM ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).
...
**Optional follow-up** (shown only if an AI option is picked): "What did you ask the AI? (optional)". This captures real buyer wording for the prompt library. The Semrush measurement guide mentions form tools such as Tally that let users type the query they used ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).
...
4. Each month, count answers by option for the G4 KPI in [kpis-and-dashboard.md](kpis-and-dashboard.md). Within one or two quarters this should be Quotr's best evidence of which channels matter (playbook inference).

---

## 7. Monthly manual prompt test (the routine)

The full method, all 53 prompts and the templates are in [../04-prompt-library/tracking-set.md](../04-prompt-library/tracking-set.md). This is the checklist version.
...
4. **Record** for every run: engine and model shown, Quotr named (Y/N), position, how Quotr is described, sentiment, accuracy problems (checklist in [tracking-set.md §3.6](../04-prompt-library/tracking-set.md)), quotr.ai URLs cited, retrieved-only URLs, competitors named, top cited domains, third-party pages naming Quotr, screenshot or share link.
5. **Score** with the formulas in [tracking-set.md §3.7](../04-prompt-library/tracking-set.md): mention rate, citation rate, retrieval rate, cited-not-named count, share of voice, average position, brand accuracy. **One row per engine; never blend engines.** Use the first run for headline numbers and the second to flag "unstable" results.
6. **Log new third-party pages** that name Quotr in [../02-current-state/offsite-presence.md](../02-current-state/offsite-presence.md).
...
8. **Fill the dashboard** in [kpis-and-dashboard.md §6](kpis-and-dashboard.md) and write the 5-line monthly note ([tracking-set.md §4.4](../04-prompt-library/tracking-set.md)).

**Why monthly, not weekly:** AI citations change a lot from month to month and changes take weeks to show, so weekly prompt checks mostly measure noise ([playbook §4](<../../research_notes/Quotr GEO AEO strategy audit/geo_content_playbook_b2b.md>)).
...
| **Monthly** (first week) | Half a day (Lite) to 2 days (Standard, by hand) | Full prompt test (§7); Search Console Generative AI report and branded search; Bing AI Performance; GA4 AI channel and landing pages; form answers; reviews and list inclusions; crawler health | Monthly dashboard ([kpis-and-dashboard.md §6](kpis-and-dashboard.md)) plus the 5-line note |
| **Quarterly** | 1 day | 3-month trends by engine; re-score [presence-scorecard.md](../02-current-state/presence-scorecard.md); Claude and Copilot runs; branded-search trend; AI vs organic conversion comparison; swap in up to 5 new prompts ([tracking-set.md §5](../04-prompt-library/tracking-set.md)); update the GA4 regex with new AI sources; review tool choice and budget ([tools-comparison.md](tools-comparison.md)); review targets | Quarterly review deck or doc for Quotr leadership |
| **Day-90 review** (late December 2026) | Half a day | Compare against the 90-day targets in [kpis-and-dashboard.md §4](kpis-and-dashboard.md); decide the next quarter's priorities | Short decision memo |
...
- [kpis-and-dashboard.md](kpis-and-dashboard.md) — KPI definitions, September 2026 baseline, suggested targets and the monthly dashboard
- [tools-comparison.md](tools-comparison.md) — paid AI-visibility trackers vs the free manual routine
- [../04-prompt-library/tracking-set.md](../04-prompt-library/tracking-set.md) — the 53 tracked prompts, run rules and templates
- [../02-current-state/ai-visibility-baseline.md](../02-current-state/ai-visibility-baseline.md) — September 2026 results and method
- [../02-current-state/website-audit.md](../02-current-state/website-audit.md) — robots.txt, sitemaps, Cloudflare and staging-site findings
- [../01-geo-fundamentals/how-ai-engines-choose-sources.md](../01-geo-fundamentals/how-ai-engines-choose-sources.md) — how each engine finds pages, and the full crawler table
- [../01-geo-fundamentals/traffic-and-funnel-impact.md](../01-geo-fundamentals/traffic-and-funnel-impact.md) — why AI traffic is undercounted and reach is measured as presence
- [../08-action-plan/30-60-90-plan.md](../08-action-plan/30-60-90-plan.md) — where measurement setup sits in the plan
